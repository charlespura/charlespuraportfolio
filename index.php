...
<script>
  ...
  <div class="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
    <div class="text-xl font-bold text-black dark:text-white md:text-lg sm:text-base">MyPortfolio</div>
    ...
    <div class="flex items-center space-x-4">
      <button id="theme-toggle" class="p-2 rounded-full bg-gray-200 dark:bg-gray-700 transition">
        <svg id="theme-icon" class="theme-icon w-6 h-6 text-black dark:text-white" xmlns="http://www.w3.org/2000/svg" fill="none"
      ...
      <button id="hamburger" class="md:hidden p-2 rounded-full bg-gray-200 dark:bg-gray-700 transition">
  ...
  <!-- Mobile Nav -->
  <nav id="mobile-menu" class="hidden md:hidden flex-col space-y-4 bg-white/90 dark:bg-black/90 backdrop-blur p-4 rounded-md mx-4 mt-2">
...
<!-- Hero Section -->
<section id="hero" class="relative h-screen flex flex-col justify-center items-center pt-32 bg-[#f5f5f5] dark:bg-gray-800 transition-colors duration-500">
...
<script>
  ...
  window.addEventListener('scroll', () => {
    ...
    // Clamp scroll offset between 0 and 300 (adjust maxScroll to control range)
    const maxScroll = 500;
    const maxTranslate = 250; // max 40px down
  ...
  <!-- Image below hero content -->
  <img src="charlesbg.png" alt="Charles Background" class="mt-8 w-full max-w-2xl rounded-lg shadow-lg">
...
<section id="about" class="min-h-screen flex flex-col items-center justify-start bg-white dark:bg-black px-6 md:px-10 py-16">
  ...
  <div class="w-full max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-start gap-10">
    ...
    <!-- Left: Text -->
    <div class="md:flex-1">
      <p class="text-base leading-relaxed text-gray-700 dark:text-gray-300 font-mono text-justify">
...
<section id="projects" class="min-h-screen flex flex-col items-center justify-center text-center bg-white dark:bg-black px-4 transition-colors duration-500 py-16">
  ...
  <p class="text-lg text-gray-700 dark:text-gray-300 max-w-2xl mb-12">
    I've created <span class="font-semibold text-blue-600 dark:text-blue-400">152+</span> and counting — including <strong>Diagrams</strong>, <strong>Web Systems</strong>, <strong>CRUD Operations</strong>, <strong>Android Apps</strong>, and more. Check out some of my featured work below!
  </p>
 ...
 <div id="project-grid" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-8 mb-16 transition-opacity duration-500 opacity-100">
   ...
   <!-- Logistics System -->
<div class="bg-white dark:bg-gray-700 rounded-xl shadow-md p-4 cursor-move">
...
<div class="bg-white dark:bg-gray-700 rounded-xl shadow-md p-4 cursor-move">
  ...
  <div class="flex space-x-3 items-center">
    ...
    <div class="tooltip">
      <!-- Using generic biometric fingerprint icon -->
...
<!--
  Notes:
  - Your custom classes `border-n-4`, `text-n-5`, `bg-n-4/20` are preserved as you asked.
  - The active pagination button has `bg-n-4/20` background and white text for highlight.
  - Smooth fade animation on project grid when switching pages.
  - Pagination buttons are fully functional with disabled states on first/last pages.
-->
...
<section id="contact" class="min-h-screen flex flex-col items-center justify-center text-center bg-[#f5f5f5] dark:bg-gray-800 px-4 transition-colors duration-500 py-16">
  ...
  <script>
    ...
    form.addEventListener('submit', function(event) {
      ...
      submitButton.classList.add("animate-message-sent");
      ...
      setTimeout(() => {
        ...
        submitButton.classList.remove("animate-message-sent");  // Remove animation class
      }, 2000);  // 2 seconds delay before reset
    });
  </script>

  <style>
    /* Animation for Message Sent button */
    .animate-message-sent {
      animation: fadeInScale 1s ease-out;
    }

    /* Keyframe animation for fade and scale effect */
